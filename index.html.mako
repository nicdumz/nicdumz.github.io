    ...
    <div class="container">
      <div class="columns">
        ...
        <div class="column content">
            ...
            <p>There isn't much here, besides a desolated, neglected technical <span class="icon is-small"><i class="fa fa-paper-plane" aria-hidden="true"></i></span> <a class="is-link" href="/blog/">Blog</a>. Maintaining this site is mostly a nice excuse to force myself to read every other year about the latest web trends, though. Responsive. 2.0. All that jazz. Yay. Aren't we excited now.</p>
        </div>
      </div>
    </div>
  </section>
